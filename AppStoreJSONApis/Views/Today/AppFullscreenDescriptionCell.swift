...
class AppFullscreenDescriptionCell: UITableViewCell {
    ...
    let descriptionLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: "\nBattle in dungeons. Collect treasure. Solve puzzles. Sail to new lands. Oceanhorn lets yout do it all in a beautifully detailed world.", attributes: [.foregroundColor: UIColor.gray]))
